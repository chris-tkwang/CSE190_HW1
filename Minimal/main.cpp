...
public:
	...
	void render(const glm::mat4& projection, const glm::mat4& view, unsigned int index) {
		glm::mat4 toWorld = instance_positions[index] * glm::scale(glm::mat4(1.0f), glm::vec3(0.035f));
...
protected:
	...
	void renderScene(const glm::mat4& projection, const glm::mat4& headPose) override {
		...
		for (unsigned int i = 0; i < NUM_SPHERES; i++) {
			...
			// Render Sphere
			sphereScene->render(projection, glm::inverse(headPose), i);
		}
